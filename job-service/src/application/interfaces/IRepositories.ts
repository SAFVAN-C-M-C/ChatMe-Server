import { ApplicationParams, GetApplicationParams, GetMyApplicationParams, IApplication, ICreateJob, IEditJob, IJobs, ParamsForJobDataChart, UpdateStatus } from "@/domain/entities";
...
export interface IRepositories {
    ...
    searchJob:(data:{searchKey:string,filter:string})=>Promise<IJobs[] | null>;
    ...
    getJobApplications:(data:GetApplicationParams)=>Promise<IApplication[]|null>;
    getMyJobApplications:(data:GetMyApplicationParams)=>Promise<IApplication[]|null>;
