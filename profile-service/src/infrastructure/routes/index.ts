...
export const routes = (dependencies: IDependencies) => {
  const { getUserProfile,applyRecruiter,updateAvatar,updateBio,updateAbout,addEducation,addExperience,addSkills,addPreferedJobs,acceptRecruiter,ignoreRecruiter } =
